...
// Block defines a litecoinfinance block that provides easier and more efficient
...
// Tx returns a wrapped transaction (ltfnutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (ltfnutil.Tx) for all
...
// instead provides easy access to wrapped versions (ltfnutil.Tx) of them.
...
// NewBlock returns a new instance of a litecoinfinance block given an underlying
...
// NewBlockFromBytes returns a new instance of a litecoinfinance block given the
...
// NewBlockFromReader returns a new instance of a litecoinfinance block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a litecoinfinance block given
