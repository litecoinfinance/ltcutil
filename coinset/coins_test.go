...
import (
	...
	"github.com/litecoinfinance/ltfnutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    ltfnutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() ltfnutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value ltfnutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = ltfnutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = ltfnutil.NewTxFromBytes(testSimpleCoinTxBytes)
